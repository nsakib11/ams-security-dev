...
public class AesCbcUtilTest {
    ...
    private int INTERACTION_COUNT = 1000;
    ...
    private String  SALT = "fa91065ebff733b9fad5497f2b7dacdc";
    private String  IV = "465f899cae94b80c72411935556cb113";

    private String  PASSPHRASE = "mypassphrase";
    private final Cipher cipher;

    public AesCbcUtilTest() {
        try {
    ...
    public static void main(String[] args) {
        AesCbcUtilTest aesCbcUtil = new AesCbcUtilTest();
        System.out.println("Print password = " + aesCbcUtil.encrypt("test0123"));
    }
}
